			...
			<div class="content">
				<div class="products-agileinfo">
					...
					<div class="container">
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="{{ asset('/front-end/images/') }}" alt=""></a>
										</div>
                        ...
                        @foreach($category_products as $category_produst)
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{ asset($category_produst->product_image) }}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{ asset($category_produst->product_image) }}" class="img-responsive"  alt="">
																	</div>
														...
														<div class="women">
															<h6><a href="single.html">{{ $category_produst->product_name }}</a></h6>
															<span class="size">XL / XXL / S </span>
															<p ><em class="item_price">TK. {{ $category_produst->product_price}}</em></p>
  											...
  											<div class="product-tab1">
  												...
  												<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
  													...
  													<div class="women">
  														<h6><a href="single.html">{{ $category_produst->product_name }}</a></h6>
  														<span class="size">XL / XXL / S </span>
  														<p>{{ $category_produst->short_description }}</p>
  														<p ><del>$100.00</del><em class="item_price">TK. {{ $category_produst->product_price}}</em></p>
  														<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
  													</div>
  												</div>
