				...
				<div class="new-arrivals-w3agile">
					<div class="container">
						...
						<div class="arrivals-grids">
							...
							<div class="col-md-3 arrival-grid simpleCart_shelfItem mb-3">
								<div class="grid-arr">
									...
									<div class="women">
										...
										<a href="{{ route('product_details',['id' =>$product->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
									</div>
								</div>
							</div>
