							...
							<div clas="single-top">
								<div class="single-left">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="{{ asset($single_products->product_image) }}">
												<div class="thumb-image"> <img src="{{ asset($single_products->product_image) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset($single_products->product_image) }}">
												 <div class="thumb-image"> <img src="{{ asset($single_products->product_image) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
								...
								<div class="single-right simpleCart_shelfItem">
									<h4>{{ $single_products->product_name }}</h4>
									<div class="block">
										<div class="starbox small ghosting"> </div>
									</div>
									<p class="price item_price">TK. {{ $single_products->product_price }}</p>
									<div class="description">
										<p><span>Quick Overview : </span> {{ $single_products->short_description }}</p>
									</div>
									<form class="" action="{{ route('add-to-cart') }}" id="cartForm" method="post">
										@csrf
											...
											<h6>Quantity :</h6>
												<div class="quantity">
													<div class="quantity-select">
														...
														<input type="number" name="qty" id="quantity" value="1" class="entry value1">
										...
										<div class="women">
											...
											<a href="#" data-text="Add To Cart" onclick="event.preventDefault(); document.getElementById('cartForm').submit()" id="submitCartForm"  class="my-cart-b item_add">Add To Cart</a>
										</div>
